...
```
Consutruccion de las funciones impulso respuesta:

Funcion impulso respuesta : Impulso el ingreso , respuesta el consumo
Se asume que los choques son independientes por tanto ponemos que las funciones impulso respuesta no son ortogonales
```{r}
feincos <- irf(model, impulse = "income", response = "cons",n.ahead = 8, ortho = FALSE, runs = 1000)
...
```
Estos impulso repsuesta no son totalmente seguros ya que hay relación entre las variables del modelo var , como se ve en la matriz de corelaciones , por tanto hay relaciones contemporaneas.

Luego necesitamos que la función impulso respuesta sea ortogonal, que nos ayuda a que no hallan relaciones entre las variables.
...
plot(fuincons)
```
Interpretación : Un choque en  una desviacion estandar de   el ingreso , hace que el consumo disminuya en un 0.0067% en el primer trimestre , llegando al maximo de impacto en el tercer trimestre 0.0068% , y despues cayendo a impactos menores de 0.0048% en los trimestres siguientes, disminuyendo hasta 0.0033% en el trimestre 8.
...
Interpretación : Para un choque en una desviacion estandar de la inversión , la respuesta tiene su maximo en el trimestre 2, en donde se observa un aumento porcentual en el ingreso de 0.0026% , posterior a dicho trimestre el impacto de este choque disminuye hasta llegar a ser 0.0013% en el trimestre 8.
...
plot(fuinvco)
```
Interpretación : Para un choque de una desviación estandar en la inversión el consumo disminuye en un 0.0027% , alcanzando su maximo en le periodo 3 , 0.0036% , y posterior a dicho trimestre la respuesta disminuye hasta 0.001347% en el periodo 8.
...
Para un choque de una desviación estandar en la inversión en el trimestre 1 la inversion  disminuye en un 0.0033% , siendo este su maximo impacto , y posterior a dicho trimestre el impacto  disminuye hasta 0.001351% en el periodo 8.
...
Para un choque de una desviación estandar en el ingreso en el trimestre 1 la inversion  disminuye en un 0.012% , siendo este su maximo impacto , y posterior a dicho trimestre el impacto disminuye hasta 0.0034% en el periodo 8.
...
Para un choque de una desviación estandar en el consumo en el trimestre 1 el consumo disminuye en un 0.0080% , siendo este su maximo impacto , y posterior a dicho trimestre el impacto disminuye hasta 0.001432% en el periodo 8.