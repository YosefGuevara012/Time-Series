...
plot(tiempo,data[,3], ylab = "Ethereum", xlab="Tiempo", type="l", col = "#46008B")
plot(tiempo,data[,14], ylab = "Tesla", xlab="Tiempo", type="l", col = "#8B008B")
plot(tiempo,data[,15], ylab = "TSMC", xlab="Tiempo", type="l", col = "#8B0046")
plot(tiempo,data[,16], ylab = "Nvidia", xlab="Tiempo", type="l", col = "#8B4500")
plot(tiempo,data[,18], ylab = "AMD", xlab="Tiempo", type="l", col = "#8B8B00")
...
lines(tiempo,data[,14], ylab = "Tesla", xlab="Tiempo", type="l", col = "#8B008B")
...
plot(tiempo,data2[,2], ylab = "Bitcoin", xlab="Tiempo", type="l", col = "#00008B")
lines(tiempo,data2[,3], ylab = "Ethereum", xlab="Tiempo", type="l", col = "#46008B")
lines(tiempo,data2[,14], ylab = "Tesla", xlab="Tiempo", type="l", col = "#8B008B")
...
plot(tiempo,d_est$tesla, ylab = "tesla", xlab="Tiempo", type="l", col = "#8B008B")
