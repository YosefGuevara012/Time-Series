...
tiempo <- seq(1:nrow(data2))/1506+2015.5

plot(tiempo,data2[,1], ylab = "Cotización normalizada", xlab="años", type="l", col = "red", main ="Bitcoin y otras crypto normalizadas", cex.main=0.8, cex.lab = 0.8)
...
## Visualización de los Variables seleccionadas.
...
par(mfrow=c(2,3))
plot(tiempo,data[,2], ylab = "Bitcoin", xlab="Tiempo", type="l", col = "red")
plot(tiempo,data[,3], ylab = "Ethereum", xlab="Tiempo", type="l", col = "blue")
plot(tiempo,data[,14], ylab = "Tesla", xlab="Tiempo", type="l", col = "purple")
plot(tiempo,data[,15], ylab = "TSMC", xlab="Tiempo", type="l", col = "darkgreen")
plot(tiempo,data[,16], ylab = "Nvidia", xlab="Tiempo", type="l", col = "orange")
plot(tiempo,data[,18], ylab = "AMD", xlab="Tiempo", type="l", col = "#03D8FE")
...
##  [1] "#00008B" "#46008B" "green" "#8B0046" "#8B0000" "#8B4500" "#8B8B00"
##  [8] "#468B00" "#008B00" "#008B45" "#008B8B" "#00468B"
tiempo <- seq(1:nrow(data))/1506+2015.5

plot(tiempo,data[,2], ylab = "Bitcoin", xlab="Tiempo", type="l", col = "red")
lines(tiempo,data[,3], ylab = "Ethereum", xlab="Tiempo", type="l", col = "#46008B")
lines(tiempo,data[,14], ylab = "Tesla", xlab="Tiempo", type="l", col = "green")
lines(tiempo,data[,15], ylab = "TSMC", xlab="Tiempo", type="l", col = "#8B0046")
lines(tiempo,data[,16], ylab = "Nvidia", xlab="Tiempo", type="l", col = "#8B4500")
lines(tiempo,data[,18], ylab = "AMD", xlab="Tiempo", type="l", col = "#8B8B00")
...
##  [8] "#468B00" "#008B00" "#008B45" "#008B8B" "#00468B"
tiempo <- seq(1:nrow(data))/1506+2015.5
plot(tiempo,data2[,2], ylab = "Bitcoin", xlab="Tiempo", type="l", col = "red")
lines(tiempo,data2[,3], ylab = "Ethereum", xlab="Tiempo", type="l", col = "#46008B")
lines(tiempo,data2[,14], ylab = "Tesla", xlab="Tiempo", type="l", col = "green")
lines(tiempo,data2[,15], ylab = "TSMC", xlab="Tiempo", type="l", col = "#8B0046")
lines(tiempo,data2[,16], ylab = "Nvidia", xlab="Tiempo", type="l", col = "#8B4500")
lines(tiempo,data2[,17], ylab = "AMD", xlab="Tiempo", type="l", col = "#8B8B00")
...
tiempo <- seq(1:nrow(d_est))/1505+2015.5 
par(mfrow=c(2,3))
plot(tiempo,d_est$bitcoin, ylab = "Bitcoin", xlab="Tiempo", type="l", col = "#00008B")
plot(tiempo,d_est$ethereum, ylab = "Ethereum", xlab="Tiempo", type="l", col = "#46008B")
plot(tiempo,d_est$tesla, ylab = "tesla", xlab="Tiempo", type="l", col = "green")
plot(tiempo,d_est$tsmc, ylab = "TSMC", xlab="Tiempo", type="l", col = "#8B0046")
plot(tiempo,d_est$nvidia, ylab = "Nvidia", xlab="Tiempo", type="l", col = "#8B4500")
plot(tiempo,d_est$amd, ylab = "AMD", xlab="Tiempo", type="l", col = "#8B8B00")
...
```{r}
var_irf <- irf(var_s, response = "ethereum",impulse = "bitcoin",n.ahead = 12, boot=T)
var_irf 
```
